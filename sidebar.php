...
<section class="submenu" id="pc_nav">
  ...
  <dl>
    ...
    <a href="<?php echo esc_url(home_url('company'));?>#skill_graph">
      <dd>ー  能力レベル表</dd>
    </a>
    <a href="<?php echo esc_url(home_url('company'));?>#history">
      <dd>ー  学習遍歴</dd>
    </a>
    <a href="<?php echo esc_url(home_url('company'));?>#wp_recommend">
      <dd>ー  WordPress紹介</dd>
    </a>
    ...
    <a href="<?php echo esc_url(home_url('service'));?>/#after_follow">
      <dd>ー  公開した後も安心</dd>
    </a>
    ...
    <a href="<?php echo esc_url(home_url('/blogs/')); ?>#new_blog">
      <dd>ー  新着記事</dd>
    </a>
    <a href="<?php echo esc_url(home_url('/blogs/')); ?>#modal_open">
      <dd>ー  条件絞り込み検索</dd>
    </a>
    ...
    <a href="<?php echo esc_url(home_url('')); ?>#greeting">
      <dd>ー  ご挨拶</dd>
    </a>
